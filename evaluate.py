...
"""
Comprehensive evaluation script for G-Align model
Tests the model on various downstream tasks with different settings
"""
...
class GAlignEvaluator:
    """Comprehensive evaluator for G-Align model."""
    ...
    def evaluate_few_shot_scaling(self, 
        ...
        """
        Evaluate how performance scales with number of shots.
        
        Args:
            dataset_name: Dataset to evaluate on
            k_shots: List of k values to test
            n_episodes: Number of episodes per k
    ...
    def evaluate_cross_domain(self,
        ...
        Args:
            source_datasets: Datasets used in pretraining
            target_datasets: Datasets to evaluate on
            k_shot: Number of support examples
            n_episodes: Number of episodes
            
        Returns:
            DataFrame with cross-domain results
        """
        ...
        for target in target_datasets:
            ...
            # Check if target was in pretraining
    ...
    def evaluate_m_way_scaling(self,
        ...
        """
        Evaluate how performance scales with number of classes (m-way).
        
        Args:
            dataset_name: Dataset to evaluate on
            m_ways: List of m values to test
            k_shot: Number of support examples
            n_episodes: Number of episodes
    ...
    def _plot_cross_domain(self, df: pd.DataFrame, save_dir: str):
        """Plot cross-domain transfer results."""
    ...
    def run_comprehensive_evaluation(self,
        ...
        Args:
            ...
            pretrain_datasets: Datasets used in pretraining
        """
        logger.info("Starting comprehensive evaluation...")
        
        # 1. Few-shot scaling evaluation
        if test_datasets:
